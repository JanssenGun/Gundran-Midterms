...
app.post('/', function(req, res) {
    ...
    // This responds a Get request for the /list user page.
...
app.get('/jamg', function(req, res) {
    console.log("Got a GET request for /jamg");
    res.send('jamg = Janssen Andrae M. Gundran');
})
